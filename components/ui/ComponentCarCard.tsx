...
import { ComponentCarDetails, ComponentCustomButton } from "@/components";
...
const ComponentCarCard = ({ car } : CarCardProps) => {
          ...
          <div className="flex group-hover:invisible w-full justify-between text-grey">
            <div className="flex flex-col justify-center items-center gap-2">
              ...
              <p className="text-[14px]">
                {transmission === "a" ? 'Automatique' : "Manuel"}
              </p>
            </div>
            <div className="flex flex-col justify-center items-center gap-2">
...
export default ComponentCarCard;